const CACHE_NAME = 'lor-v3-1-fixes';
const APP_SHELL = [
  './','./index.html','./manifest.webmanifest',
  './src/app.js','./src/auth.js','./src/firebase.js','./src/store.js','./src/round-flow.js','./src/seed-data.js','./src/v3-core.js','./src/v31-runtime.js',
  './src/styles/tokens.css','./src/styles/base.css','./src/styles/v3.css','./src/styles/v31.css',
  './assets/opex-hub-logo.png'
];
